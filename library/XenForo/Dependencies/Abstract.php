...
abstract class XenForo_Dependencies_Abstract
{
	...
	*/
	...
	public function preRenderView(XenForo_ControllerResponse_Abstract $controllerResponse = null)
	{
		...
		$this->_defaultTemplateParams['contactUrl'] = XenForo_Dependencies_Public::getContactUrl();
		$this->_defaultTemplateParams['privacyPolicyUrl'] = XenForo_Dependencies_Public::getPrivacyPolicyUrl();
		$this->_defaultTemplateParams['tosUrl'] = XenForo_Dependencies_Public::getTosUrl();
