...
{
	public static function sendErrorPageHeaders()
	{
	...
	public static function unexpectedException($e)
	{
		$isValidArg = ($e instanceof Exception || $e instanceof Throwable);
		if (!$isValidArg)
		{
			throw new Exception("unexpectedException requires an Exception or a Throwable");
		}
	...
	public static function getExceptionTrace($e)
	{
		$isValidArg = ($e instanceof Exception || $e instanceof Throwable);
		if (!$isValidArg)
		{
