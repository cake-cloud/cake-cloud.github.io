...
class XenForo_ViewRenderer_HtmlPublic extends XenForo_ViewRenderer_Abstract
{
	...
	*/
	...
	protected function _getNoticesContainerParams(XenForo_Template_Abstract $template, array $containerData)
	{
		...
		if ($template->getParam('showCookieNotice'))
		{
			$notices['bottom_fixer']['-1'] = array(
				'title' => new XenForo_Phrase('notice_cookies'),
				'message' => $template->create('notice_cookies', $template->getParams()),
				'wrap' => true,
				'dismissible' => true
			);
		}
