...
$tables['xf_spam_cleaner_log'] = "
	CREATE TABLE xf_spam_cleaner_log (
		...
		KEY user_id (user_id),
		KEY applying_user_id (applying_user_id)
	) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci
";
...
$tables['xf_warning'] = "
	CREATE TABLE xf_warning (
		...
		KEY is_expired_expiry (is_expired, expiry_date),
...
$data['xf_bb_code_media_site'] = '
	...
	VALUES
		...
		(\'vimeo\', \'Vimeo\', \'http://www.vimeo.com\', \'vimeo.com/{$id:digits}\nvimeo.com/groups/*/videos/{$id:digits}\', \'<iframe src="https://player.vimeo.com/video/{$id}" width="500" height="300" frameborder="0" allowfullscreen></iframe>\', 0),
